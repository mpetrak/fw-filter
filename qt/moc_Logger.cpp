...
**
** Created: Fri Mar 22 12:11:32 2013
...
static const char qt_meta_stringdata_Logger[] = {
    "Logger\0\0message\0newMessage(const char*)\0"
};
...
int Logger::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: newMessage((*reinterpret_cast< const char*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void Logger::newMessage(const char * _t1)
{
