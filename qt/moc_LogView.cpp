...
**
** Created: Fri Apr 26 19:56:58 2013
...
static const char qt_meta_stringdata_LogView[] = {
    "LogView\0\0message\0addMessage(const char*)\0"
};

const QMetaObject LogView::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_LogView,
      qt_meta_data_LogView, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LogView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LogView))
...
int LogView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: addMessage((*reinterpret_cast< const char*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
